...
op_spec.inputs(2).max = inf*ones(length(InputNames),1); % 25deg default
op_spec.inputs(2).min = -inf*ones(length(InputNames),1); % -25deg default
...
switch lower(AC.aircraft)
    case {'ultrastick120', 'ultrastick25e','minimutt_rigid'}
