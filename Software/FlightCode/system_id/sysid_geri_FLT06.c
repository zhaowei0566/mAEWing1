	...
	switch(missionData_ptr -> sysid_select){
		case 0: 
			...
			if (time < 1.5){
				...
				controlData_ptr->surf3_excite = playback_OMS2_1(indx - 1.5*150, 5.0*D2R);
				controlData_ptr->surf4_excite = playback_OMS2_2(indx - 1.5*150, 3.5*D2R);
				if(overspeed == FALSE) {
				...
				controlData_ptr->surf1_excite = playback_OMS2_1(indx - 15.0*150, 5.0*D2R);
				controlData_ptr->surf2_excite = playback_OMS2_2(indx - 15.0*150, 5.0*D2R);
				if(overspeed == FALSE) {
		...
		case 1:
			...
			if (time < 1.5){
				...
				controlData_ptr->surf2_excite = playback_OMS2_1(indx - 1.5*150, 3.2*D2R);
				controlData_ptr->surf4_excite = playback_OMS2_2(indx - 1.5*150, 2.0*D2R);
				if(overspeed == FALSE) {
					controlData_ptr->l2    += controlData_ptr->surf2_excite;
					controlData_ptr->r2    -= controlData_ptr->surf2_excite;
					controlData_ptr->l4    += controlData_ptr->surf4_excite;
				...
				controlData_ptr->surf1_excite = playback_OMS2_1(indx - 15.0*150, 5.0*D2R);
				controlData_ptr->surf4_excite = playback_OMS2_2(indx - 15.0*150, 2.5*D2R);
				if(overspeed == FALSE) {
					controlData_ptr->l1    += controlData_ptr->surf1_excite;
					controlData_ptr->r1    += controlData_ptr->surf1_excite;
					controlData_ptr->l4    += controlData_ptr->surf4_excite;
		...
		case 2:
			...
			if (time < 12.0){
				...
				controlData_ptr->surf4_excite = playback_OMS4_4(indx - 12*150, 2.5*D2R);
				if(overspeed == FALSE) {
					controlData_ptr->l1    += controlData_ptr->surf1_excite;
					controlData_ptr->r1    += controlData_ptr->surf2_excite;
					controlData_ptr->l4    += controlData_ptr->surf3_excite;
					controlData_ptr->r4    += controlData_ptr->surf4_excite;
				}
			}
			
			controlData_ptr->cmp_status = time / (24.0) * 100.0;
			break;
	}
}
