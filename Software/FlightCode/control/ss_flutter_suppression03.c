...
extern void init_ss03_control(void){
	...
	SS_B[0][0] = 0.0000122227509403;
	SS_B[1][0] = 0.0000311179685981;
	SS_B[2][0] = 0.0000381003340171;
	SS_B[3][0] = 0.0143785259468936;

	SS_C[0][0] = -0.0000000000000000;
	SS_C[0][1] = -0.0000000000000000;
