...
extern void get_system_id( double time, struct sensordata *sensorData_ptr, struct nav *navData_ptr, struct control *controlData_ptr, struct mission *missionData_ptr){
	...
	// 3-2-1-1 Roll on ganged then surface pairs
		...
		if((time-t0)<4.5){
			...
			controlData_ptr->l1   += controlData_ptr->roll_cmd_excite;
			controlData_ptr->r1   -= controlData_ptr->roll_cmd_excite;			
		}
			...
			controlData_ptr->l2 += controlData_ptr->roll_cmd_excite;
			controlData_ptr->r2 -= controlData_ptr->roll_cmd_excite;
			controlData_ptr->l4 += controlData_ptr->roll_cmd_excite;		
			controlData_ptr->r4 -= controlData_ptr->roll_cmd_excite;			
		}
