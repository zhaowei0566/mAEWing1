...
/// Return control outputs based on references and feedback signals.
    ...
    controlData_ptr->de = controlData_ptr->pitch_cmd_pilot - PITCH_SURF_TRIM;		// Elevator deflection [rad]
	controlData_ptr->da = controlData_ptr->roll_cmd_pilot - ROLL_SURF_TRIM; 		// Aileron deflection [rad]
